...
INCLUDE_PATTERN = (
    ...
    r"电力|绿电|公用|水电|燃气|水务|电网|电信|集成电路|粮食|农牧|高端装备|工业互联网"
)
EXCLUDE_PATTERN = (
...
SECTOR_PATTERNS = [
    ...
    ("银行", r"银行"),
    ("金融地产", r"金融地产|金融"),
    # ---- 大科技TMT 细分(实验#11,首匹配顺序:半导体>消费电子>传媒>通信软件) ----
    ("半导体芯片", r"半导体|芯片|存储|晶圆|集成电路"),
    ("消费电子", r"消费电子|电子|光电|面板|光学|元器件"),
    ("传媒文娱", r"传媒|影视|文娱|动漫|游戏|文化|娱乐"),
    ("通信软件AI", r"通信|5G|计算机|软件|信息安全|云计算|人工智能|大数据|TMT|信息技术|电信|工业互联网"),
    ("军工", r"军工|航天|航空|国防"),
    ...
    ("煤炭", r"煤炭"),
    ("石油能源", r"能源|石油|油气"),
    ("有色金属", r"有色金属|有色|稀土|矿业|锂|钴"),
    ("原材料", r"原材料|钢铁|化工|新材料"),
    ("汽车", r"汽车|零部件"),
    ("农业", r"农业|畜牧|养殖|种植|渔业|粮食|农牧"),
    ("机械", r"机械|工业母机|机床|机器人|高端装备"),
    ("基建建材", r"基建|建筑材料|建材|建筑"),
    ("房地产", r"房地产|地产"),
    ("电力公用", r"电力|绿电|公用事业|水电|燃气|水务|电网"),
    ("环保", r"环保"),
